...
global.ownername = 'DivSan' //Masukin nama kamu
global.botname = 'DivanPtrBotz' //Masukin nama bot kamu
global.fakename = 'DivSan' //Masukin nama mu
global.fakebody = 'Hubungi jika ingin sewabot' // Monggo kalau mau ganti
global.packname = 'DivanPtrBotz' //Gakusah di ubah kalau mau di ubah Monggo 
global.author = 'DivSan' //Monggo kalau mau ubah
...
global.githubmu = 'https://github.com/DivSan' //Isi nama github mu
global.ytmu = 'https://youtube.com/@DivSan-' //Gak usah di ubah
global.ytvmu = 'https://youtube.com/@DivSan-' //Gak usah di ubah
global.linkbebas = 'https://chat.whatsapp.com/JVQ60oSsvJ1CtstXzk' //Terserah mau luh isi web apa mau github atau link group juga bisa
